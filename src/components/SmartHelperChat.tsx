...
export default function SmartHelperChat() {
  ...
  const sendMessage = async () => {
    ...
    const rules = [
      ...
      { pattern: /مشكلة في الحجز|فشل الحجز|مش راضي يحجز|تعليق الحجز/i, response: "أعتذر جداً عن هذه المشكلة. تأكد من استقرار الإنترنت، أو جرب إعادة تحميل الصفحة. إذا استمرت المشكلة، يرجى التواصل مع الدعم الفني عبر واتساب على الرقم: 01554353231." },
