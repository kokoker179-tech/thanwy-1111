...
export default function SmartHelperChat() {
  ...
  const sendMessage = async () => {
    ...
    const rules = [
      ...
      { pattern: /حجز|احجز|عايز احجز/i, response: "يمكنك الحجز بسهولة من خلال زيارة صفحة 'احجز الآن' الموجودة في القائمة الرئيسية بالموقع. هل واجهت أي صعوبة في صفحة الحجز؟" },
      { pattern: /مشكلة في الحجز|فشل الحجز|مش راضي يحجز|تعليق الحجز|مشكلة في الموقع|الموقع مش شغال|خطأ في الموقع|عطل|مشكلة فنية/i, response: "أعتذر جداً عن هذه المشكلة! بخصوص مشاكل الموقع التقنية أو الحجز، يرجى التواصل فوراً مع الدعم الفني عبر واتساب على الرقم: 01554353231." },
      { pattern: /رسالة تأكيد|لم تصلني رسالة|فين الرسالة|وصلت الرسالة|رسالة الحجز/i, response: "غالباً ما تصل رسالة التأكيد خلال دقائق. تأكد من مراجعة مجلد الرسائل المزعجة (Spam) في بريدك الإلكتروني، أو تأكد من صحة رقم الهاتف والبريد المسجلين." },
